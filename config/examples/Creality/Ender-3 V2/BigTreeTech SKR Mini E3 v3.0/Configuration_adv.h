...
//
#define NUM_Z_STEPPER_DRIVERS 1   // (1-4) Z options change based on how many  //WPAmod
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 500 //WPAmod
  ...
  #define BLTOUCH_FORCE_SW_MODE //WPAmod
   ...
   */
  #define BLTOUCH_HS_MODE true //WPAmod

  // Safety: Enable voltage mode settings in the LCD menu.
  #define BLTOUCH_LCD_VOLTAGE_MENU //WPAmod
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu //WPAmod
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0 //WPAmod
  ...
  #define LCD_INFO_MENU
    ...
    #define LCD_PRINTER_INFO_IS_BOOTSCREEN // Show bootscreen(s) instead of Printer Info pages //WPAmod
  #endif
  ...
  #define SOUND_MENU_ITEM   // Add a mute option to the LCD menu //WPAmod
#endif
  ...
  #define LCD_SHOW_E_TOTAL  //WPAmod

  /**
   * LED Control Menu
   * Add LED Control to the LCD menu
   */
  //#define LED_CONTROL_MENU  //WPAmod
...
// LCD Print Progress options
    ...
    #define SHOW_REMAINING_TIME         // Display estimated time to completion  //WPAmod
    #if ENABLED(SHOW_REMAINING_TIME)
      #define USE_M73_REMAINING_TIME    // Use remaining time from M73 command instead of estimation  //WPAmod
      #define ROTATE_PROGRESS_DISPLAY   // Display (P)rogress, (E)lapsed, and (R)emaining time  //WPAmod
    #endif
  #endif

  #if EITHER(HAS_MARLINUI_U8GLIB, EXTENSIBLE_UI)
    #define PRINT_PROGRESS_SHOW_DECIMALS // Show progress with decimal digits  //WPAmod
  #endif

  #if EITHER(HAS_MARLINUI_HD44780, IS_TFTGLCD_PANEL)
    #define LCD_PROGRESS_BAR            // Show a progress bar on HD44780 LCDs for SD printing  //WPAmod
  ...
  #define MEDIA_MENU_AT_TOP               // Force the media menu to be listed on the top of the main menu  //WPAmod
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY//WPAmod
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   true // Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)//WPAmod
 ...
 */
  ...
  #define STATUS_ALT_BED_BITMAP     // Use the alternative bed bitmap  //WPAmod
  #define STATUS_ALT_FAN_BITMAP     // Use the alternative fan bitmap  //WPAmod
  //#define STATUS_FAN_FRAMES 3       // :[0,1,2,3,4] Number of fan animation frames
  #define STATUS_HEAT_PERCENT       // Show heating in a progress bar  //WPAmod
  #define BOOT_MARLIN_LOGO_ANIMATED // Animated Marlin logo. Costs ~3260 (or ~940) bytes of PROGMEM.  //WPAmod

  // Frivolous Game Options
  #define MARLIN_BRICKOUT  //WPAmod
  #define MARLIN_INVADERS  //WPAmod
  #define MARLIN_SNAKE  //WPAmod
  #define GAMES_EASTER_EGG          // Add extra blank lines above the "Games" sub-menu  //WPAmod
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping //WPAmod
 ...
 */
#define STARTUP_COMMANDS "M28"  //"M17 Z"  //WPAmod
...
#define CUSTOM_MENU_MAIN  //WPAmod
#if ENABLED(CUSTOM_MENU_MAIN)
  #define CUSTOM_MENU_MAIN_TITLE "Custom Commands"  //WPAmod
  ...
  #define MAIN_MENU_ITEM_2_DESC "Preheat for " PREHEAT_1_LABEL  //WPAmod
  #define MAIN_MENU_ITEM_2_GCODE "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)  //WPAmod
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Preheat for " PREHEAT_2_LABEL  //WPAmod
  #define MAIN_MENU_ITEM_3_GCODE "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND)  //WPAmod
  //#define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Heat Bed/Home/Level"  //WPAmod
  #define MAIN_MENU_ITEM_4_GCODE "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nG28\nG29"  //WPAmod
  //#define MAIN_MENU_ITEM_4_CONFIRM

  #define MAIN_MENU_ITEM_5_DESC "Home & Info"  //WPAmod
 ...
 */
#define CUSTOM_USER_BUTTONS  //WPAmod
